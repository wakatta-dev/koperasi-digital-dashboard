...
export default function PengaturanClient({ initialRoles = [], initialSelectedRoleId, initialPermissions = [] }: { initialRoles?: any[]; initialSelectedRoleId?: number; initialPermissions?: any[] }) {
  const [roles, setRoles] = useState<any[]>(initialRoles || []);
  const [selectedRoleId, setSelectedRoleId] = useState<number | null>(initialSelectedRoleId ?? null);
