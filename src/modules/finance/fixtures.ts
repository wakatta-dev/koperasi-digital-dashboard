...
export const sampleSummaryResponse: SalesSummaryResponse = {
  ...
  transaction_count: 0,
  average_ticket: 0,
  delta_label: undefined,
  delta_direction: undefined,
...
export const sampleCashFlowResponse: CashFlowResponse = {
  ...
  rows: [
    ...
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      subcategory: "Penerimaan Kas",
      description: "Penerimaan dari Bunga",
      amount: 75_000_000,
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      subcategory: "Penerimaan Kas",
      description: "Penerimaan dari Refund Pajak",
      amount: 45_000_000,
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      ...
      amount: 3_370_000_000,
      highlight: true,
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      subcategory: "Pembayaran Kas",
    ...
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      subcategory: "Pembayaran Kas",
      description: "Pembayaran untuk Beban Operasional",
      amount: -650_000_000,
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
    ...
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      subcategory: "Pembayaran Kas",
      description: "Pembayaran Bunga",
      amount: -125_000_000,
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      subcategory: "Pembayaran Kas",
      description: "Total Pembayaran Kas",
      amount: -2_950_000_000,
      highlight: true,
    },
    {
      category: "Arus Kas dari Aktivitas Operasi",
      description: "Arus Kas Bersih Aktivitas Operasi",
      amount: 420_000_000,
      highlight: true,
    },
    {
    ...
    {
      category: "Arus Kas dari Aktivitas Pendanaan",
      description: "Penerimaan dari Penerbitan Saham",
      amount: 500_000_000,
    },
    {
      category: "Arus Kas dari Aktivitas Pendanaan",
    ...
    {
      category: "Arus Kas dari Aktivitas Pendanaan",
      description: "Arus Kas Bersih Aktivitas Pendanaan",
      amount: 0,
      highlight: true,
    },
    {
      category: "Ringkasan Perubahan Kas",
    ...
    {
      category: "Ringkasan Perubahan Kas",
      description: "Saldo Kas Akhir Periode",
