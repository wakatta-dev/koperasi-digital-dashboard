...
export function MarketplaceShippingSkeleton() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="w-full max-w-4xl mx-auto mb-8 pt-2">
              <div className="relative flex items-center justify-between">
                ...
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1/3 h-1 bg-[#4338ca] rounded-full z-0"></div>
                {[...Array(4)].map((_, idx) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
              <div className="lg:col-span-8 space-y-6">
                <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  <Skeleton className="h-5 w-32 bg-gray-200 dark:bg-gray-800 mb-6" />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[...Array(6)].map((_, idx) => (
                      <div key={idx} className="space-y-2">
                        <Skeleton className="h-4 w-24 bg-gray-200 dark:bg-gray-800" />
                        <Skeleton className="h-11 w-full bg-gray-200 dark:bg-gray-800 rounded-xl" />
                      </div>
                    ))}
                  </div>
                  <div className="space-y-2 mt-4">
                    <Skeleton className="h-4 w-32 bg-gray-200 dark:bg-gray-800" />
                    <Skeleton className="h-24 w-full bg-gray-200 dark:bg-gray-800 rounded-xl" />
                  </div>
                </div>
