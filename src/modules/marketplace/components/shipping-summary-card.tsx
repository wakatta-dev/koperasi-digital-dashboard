  ...
  return (
    <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 lg:p-8 sticky top-28">
      ...
      <div className="space-y-4 pb-6 border-b border-gray-100 dark:border-gray-700">
        <SummaryRow label={SHIPPING_SUMMARY.totalItemsLabel} value={SHIPPING_SUMMARY.totalItemsValue} />
        <SummaryRow label={SHIPPING_SUMMARY.shippingLabel} value={SHIPPING_SUMMARY.shippingValue} />
        <SummaryRow label={SHIPPING_SUMMARY.serviceFeeLabel} value={SHIPPING_SUMMARY.serviceFeeValue} />
        <SummaryRow
      ...
      <div className="py-6">
        <div className="flex justify-between items-center mb-1">
          <span className="font-bold text-lg text-gray-900 dark:text-white">{SHIPPING_SUMMARY.totalLabel}</span>
          <span className="font-extrabold text-2xl text-[#4338ca] dark:text-indigo-400">
            {SHIPPING_SUMMARY.totalValue}
          </span>
        </div>
      </div>
