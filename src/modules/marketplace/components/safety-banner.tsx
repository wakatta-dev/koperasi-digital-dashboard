  ...
  return (
    <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-5 border border-indigo-100 dark:border-indigo-800/50">
      <div className="flex items-center gap-3 mb-3">
        <span className="material-icons-outlined text-[#4338ca] text-2xl">verified_user</span>
        <h4 className="font-bold text-[#4338ca] dark:text-indigo-300">Transaksi Aman</h4>
      </div>
