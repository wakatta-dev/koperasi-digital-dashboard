...
import type { RentalRequestItem } from "../../types/stitch";

type RentalRequestListFeatureProps = Readonly<{
  rows: RentalRequestItem[];
  search: string;
...
const statusStyles: Record<RentalRequestItem["status"], string> = {
  Menunggu:
...
export function RentalRequestListFeature({
  rows,
  search,
  onSearchChange,
  status,
