    ...
    <div className="relative bg-white dark:bg-[#1e293b] border-b border-gray-200 dark:border-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 relative z-10">
        <div className="max-w-3xl">
          <span className="inline-block py-1 px-3 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-[#4338ca] font-semibold text-xs uppercase tracking-wide mb-4">
            {HERO_CONTENT.badge}
          </span>
          ...
          <div className="bg-white dark:bg-[#1e293b] p-2 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row gap-2 max-w-2xl">
