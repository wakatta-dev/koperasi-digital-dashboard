  ...
  return useQuery({
    ...
    queryFn: async (): Promise<ReservationSummary> => {
      ...
      return {
        ...
        bookingState: res.data.booking_state,
        paymentState: res.data.payment_state,
        normalizedPaymentStatus: res.data.normalized_payment_status,
        usageState: res.data.usage_state,
        returnState: res.data.return_state,
        ...
        latestPayment: res.data.latest_payment
          ? {
              ...
              normalizedStatus: res.data.latest_payment.normalized_status,
