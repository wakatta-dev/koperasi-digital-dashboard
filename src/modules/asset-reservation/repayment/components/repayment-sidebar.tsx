...
import { REPAYMENT_BREADCRUMB, REPAYMENT_SIDEBAR } from "../constants";
      ...
      <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-gray-700">
            <span className="text-sm text-gray-600 dark:text-gray-400">ID Tagihan</span>
            <span className="text-sm font-mono font-medium text-gray-900 dark:text-white">
              {REPAYMENT_SIDEBAR.invoiceId}
            </span>
          </div>
          <div className="space-y-3">
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600 dark:text-gray-400">Total Biaya Sewa</span>
              <span className="font-medium text-gray-900 dark:text-white">{REPAYMENT_SIDEBAR.totalCost}</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600 dark:text-gray-400">Biaya Layanan</span>
              <span className="font-medium text-gray-900 dark:text-white">{REPAYMENT_SIDEBAR.fee}</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600 dark:text-gray-400">DP yang Sudah Dibayar</span>
              <span className="font-medium text-emerald-600 dark:text-emerald-400">
                - {REPAYMENT_SIDEBAR.dpPaid}
              </span>
            </div>
            <div className="pt-4 border-t border-dashed border-gray-200 dark:border-gray-700 mt-2">
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-xl font-bold text-[#4338ca]">{REPAYMENT_SIDEBAR.remaining}</span>
              </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-100 dark:border-blue-800 flex gap-2 items-start mt-2">
            ...
            <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
              Pastikan melakukan pembayaran sebelum <span className="font-bold">{REPAYMENT_SIDEBAR.dueText}</span>{" "}
          ...
          <Button
            ...
            asChild
          >
            <a href={REPAYMENT_BREADCRUMB.confirmationHref}>
