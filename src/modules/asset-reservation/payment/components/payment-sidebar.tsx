...
import { PAYMENT_BREADCRUMB, PAYMENT_SIDEBAR } from "../constants";
    ...
    <div className="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl sticky top-24 overflow-hidden ring-1 ring-gray-900/5">
      <div className="p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
          ID Tagihan: {PAYMENT_SIDEBAR.invoiceId}
        </p>
      </div>
      <div className="p-6">
        <div className="space-y-3 mb-6">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium text-gray-900 dark:text-white">{PAYMENT_SIDEBAR.totalCost}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-gray-600 dark:text-gray-400">Biaya Layanan</span>
            <span className="font-medium text-gray-900 dark:text-white">{PAYMENT_SIDEBAR.fee}</span>
          </div>
          <div className="pt-3 border-t border-dashed border-gray-200 dark:border-gray-700">
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="font-bold text-[#4338ca] text-xl">{PAYMENT_SIDEBAR.dpDue}</span>
            </div>
        ...
        <Button
          ...
          asChild
        >
          <a href={PAYMENT_BREADCRUMB.confirmationHref}>
